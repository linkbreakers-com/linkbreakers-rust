...
pub struct QrcodeDesignServiceUpdateBody {
    ...
    #[serde(rename = "centralImageDelete", skip_serializing_if = "Option::is_none")]
    pub central_image_delete: Option<bool>,
