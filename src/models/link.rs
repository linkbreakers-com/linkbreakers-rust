...
pub struct Link {
    ...
    /// Deprecated: superseded by purpose, which carries both the aim and the audience in one field. Still returned so existing consumers keep working, but nothing writes it any more.
