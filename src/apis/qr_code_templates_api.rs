...
pub async fn qrcode_templates_service_list_qrcode_templates(configuration: &configuration::Configuration, include: Option<Vec<String>>, search: Option<&str>, page_size: Option<i64>, page_token: Option<&str>, scope: Option<&str>) -> Result<models::ListQrcodeTemplatesResponse, Error<QrcodeTemplatesServiceListQrcodeTemplatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_include = include;
